...
public class Main {
    public static void main(String[] args) {
        ...
        Map<String, Color> traptrap = new TreeMap<>();
        traptrap.put("Juliet", Color.BLUE);
        traptrap.put("Romeo", Color.GREEN);
        traptrap.put("Adam", Color.RED);
        traptrap.put("Eve", Color.BLUE);
        traptrap.put("Robert", Color.BLACK);
        traptrap.put("Mark", Color.WHITE);
        traptrap.put("Pedro", Color.YELLOW);
        traptrap.put("Cole", Color.BLUE);

        Set<String> keySet2 = traptrap.keySet();
        for (String key : keySet2) {
            Color value = traptrap.get(key);
            System.out.println(key + " : " + value);
        }
    }
}